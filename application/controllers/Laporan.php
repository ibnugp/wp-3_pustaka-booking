...
class Laporan extends CI_Controller
{
  ...
  public function laporan_anggota_pdf()
  {
    $sroot = $_SERVER['DOCUMENT_ROOT'];
		// print_r($sroot."/pustaka-booking-final/application/third_party/dompdf/autoload.inc.php");
		include $sroot."/pustaka-booking-final/application/third_party/dompdf/autoload.inc.php";
